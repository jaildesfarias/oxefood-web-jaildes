...
export default function ListEntregador () {
   ...
   function carregarLista() {
       ...
       axios.get("http://localhost:8080/api/entregador")//é uma rota com lista com um objeto cliente
       .then((response) => {
           setLista(response.data)//lista de entregador
       })
   }
                            ...
                            <Table.Body>//e um form 
                                ...
                                { lista.map(entregador => (
                                    ...
                                    <Table.Row key={entregador.id}>
                                        ...
                                        <Table.Cell>{formatarData(entregador.dataNascimento)}</Table.Cell>//Na data ele traz no formato americano
